...
def get_numb_doc():
    ...
    return user_doc_number


def get_doc_owner_name(user_doc_number):
    # user_doc_number = get_numb_doc()
...
def get_shelf_numb():
    ...
    return user_shelf_number


def move_doc_to_shelf(user_doc_number, user_shelf_number):
    # user_doc_number = get_numb_doc()
    # user_shelf_number = get_shelf_numb()
...
def get_name():
    ...
    return new_doc_owner_name


def add_new_doc(new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number):
    # new_doc_number = get_numb_doc()
    # new_doc_type = get_type_doc()
    # new_doc_owner_name = get_name()
    # new_doc_shelf_number = get_shelf()
    new_doc = {
        "type": new_doc_type,
...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            owner_name = get_doc_owner_name(get_numb_doc())
